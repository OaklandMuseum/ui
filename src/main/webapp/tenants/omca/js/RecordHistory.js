...
(function ($, fluid) {
    ...
    cspace.recordHistory.preInit = function(that) {
        that.calculateCreatedAt = function(recordModel) {
            ...
            if (createdAt) {
                var createdAtClean = createdAt.replace(/T\d\d:\d\d:\d\dZ/i,"");
                that.applier.requestChange(that.options.elPaths.createdAt, createdAtClean);
            } else {
        ...
        that.calculateUpdatedAt = function(recordModel) {
            ...
            if (updatedAt) {
                var updatedAtClean = updatedAt.replace(/T\d\d:\d\d:\d\dZ/i,"");
                that.applier.requestChange(that.options.elPaths.updatedAt, updatedAtClean);
            } else {
