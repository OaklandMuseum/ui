...
(function ($, fluid) {
    ...
    cspace.util.togglable = function (container, options) {
        ...
        that.locate("header").each(function(){
            // OMCA Check for any headers that are set to be collapsed as default
            if ($(this).hasClass("default-collapsed")) {
                $(this).addClass(that.options.styles.collapsed)
                    .addClass(that.options.styles.header).fluid("tabbable");
            } else {
                $(this).addClass(that.options.styles[that.options["default"]])
                    .addClass(that.options.styles.header).fluid("tabbable");
            }
        });
